set dest=C:\Development\bideveloperextensions\DLLs\SQL2019\Reference
...
REM copy /Y /B "Microsoft.AnalysisServices.Core.dll" "%dest%"
REM copy /Y /B "Microsoft.AnalysisServices.dll" "%dest%"
REM copy /Y /B "Microsoft.AnalysisServices.AdomdClient.dll" "%dest%"
REM copy /Y /B "Microsoft.AnalysisServices.Tabular.dll" "%dest%"
